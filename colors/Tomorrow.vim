...
let s:foreground = ["4d4d4c", 238, 81]
let s:background = ["ffffff", 231, 79]
let s:selection = ["d6d6d6", 252, 86]
let s:line = ["efefef", 254, 87]
let s:comment = ["8e908c", 102, 83]
let s:red = ["c82829", 160, 48]
let s:orange = ["f5871f", 208, 68]
let s:yellow = ["eab700", 178, 72]
let s:brightyellow = ["ffff00", 226, 76]
let s:green = ["718c00", 64, 36]
let s:aqua = ["3e999f", 31, 21]
let s:blue = ["4271ae", 25, 22]
let s:purple = ["8959a8", 97, 37]
let s:window = ["efefef", 254, 87]
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("LineNr", s:window, s:background, "")
