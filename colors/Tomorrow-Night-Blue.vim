...
let s:foreground = ["ffffff", 231, 79]
let s:background = ["002451", 17, 17]
let s:selection = ["003f8e", 18, 17]
let s:line = ["00346e", 17, 17]
let s:comment = ["7285b7", 67, 38]
let s:red = ["ff9da4", 217, 69]
let s:orange = ["ffc58f", 222, 73]
let s:yellow = ["ffeead", 229, 78]
let s:green = ["d1f1a9", 193, 61]
let s:aqua = ["99ffff", 123, 47]
let s:blue = ["bbdaff", 153, 59]
let s:purple = ["ebbbff", 219, 75]
