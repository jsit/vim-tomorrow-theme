...
let s:foreground = ["cccccc", 251, 86]
let s:background = ["2d2d2d", 235, 80]
let s:selection = ["515151", 238, 81]
let s:line = ["393939", 236, 80]
let s:comment = ["999999", 246, 84]
let s:red = ["f2777a", 210, 69]
let s:orange = ["f99157", 209, 69]
let s:yellow = ["ffcc66", 221, 73]
let s:green = ["99cc99", 114, 41]
let s:aqua = ["66cccc", 80, 42]
let s:blue = ["6699cc", 68, 38]
let s:purple = ["cc99cc", 176, 54]
