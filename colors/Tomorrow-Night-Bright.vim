...
let s:foreground = ["eaeaea", 254, 87]
let s:background = ["000000", 16, 16]
let s:selection = ["424242", 237, 80]
let s:line = ["2a2a2a", 234, 80]
let s:comment = ["969896", 245, 84]
let s:red = ["d54e53", 167, 53]
let s:orange = ["e78c45", 172, 69]
let s:yellow = ["e7c547", 184, 73]
let s:green = ["b9ca4a", 148, 57]
let s:aqua = ["70c0b1", 73, 42]
let s:blue = ["7aa6da", 110, 38]
let s:purple = ["c397d8", 176, 54]
